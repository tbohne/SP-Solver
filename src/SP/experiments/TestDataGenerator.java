...
public class TestDataGenerator {
    ...
    private static void writeConfig() {
        InstanceWriter.writeConfig(
            ...
            TRANSITIVE_STACKING_CONSTRAINTS, COST_GENERATION_APPROACH, MIN_COST, MAX_COST, ITEM_LENGTH_LB,
            ITEM_LENGTH_UB, ITEM_WIDTH_LB, ITEM_WIDTH_UB, STORAGE_AREA_SLOT_LENGTH, STORAGE_AREA_SLOT_WIDTH,
            STORAGE_AREA_VEHICLE_DISTANCE_FACTOR, NUMBER_OF_ROWS_IN_STORAGE_AREA
        );
    }
